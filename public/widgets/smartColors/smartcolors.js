 ...
 * 	smartwidgets.js - own tools and base classes library 
 *
...
class SmartColorSelectors extends SmartWidgets {
  ...
  static convertNumericProps(options = {}, propName) {
    const numericProps = ["border-width", "border-radius", "body-opacity", "is-shadow"];
...
class SmartColorSelector {
  constructor(id, options = null) {
    ...
    if (!this._root.getElementById(tmpId)) {
      const style = SmartWidgets.addElement(
        "style",
        {
          id: tmpId,
        },
    ...
    if (!this._root.getElementById(tmpId)) {
      this._defs = SmartWidgets.addElement(
        "defs",
        {
          id: tmpId,
        },
      ...
      const hueRangeDef = `<linearGradient id="hueRange" x1="0%" y1="50%" x2="100%" y2="50%">
      ...
      const lumRangeDef = `<linearGradient id="lumRange" x1="0%" y1="0%" x2="0%" y2="100%">
				<stop offset="0%" stop-color="#000000"/>
				<stop offset="50%" stop-color="rgba(204, 154, 129, 0)"/>
				<stop offset="100%" stop-color="#FFFFFF"/>
			</linearGradient>`;
      const satRangeDef = `<linearGradient id="satRange" x1="0%" y1="0%" x2="100%" y2="0%">
				<stop offset="0%" stop-color="#ffffff"/>
				<stop offset="100%" stop-color="rgba(204, 154, 129, 0)"/>
			</linearGradient>`;
      const rgbRangeDef = `<linearGradient id="rgbRange" x1="0%" y1="0%" x2="100%" y2="0%">
				<stop offset="0%" stop-color="#000000"/>
				<stop offset="100%" stop-color="rgba(204, 154, 129, 0)"/>
			</linearGradient>`;
      const opSliderDef = `<pattern id="pats" x="0" y="0" width="0.04" height="1">
  ...
  _build() {
    ...
    if (!this._body) {
      ...
      this._bodyG = SmartWidgets.addElement(
        "g",
        {
          class: "stcrs",
        },
      ...
      this._body = SmartWidgets.addElement(
        "rect",
        {
          class: "stcrs body",
          x: 0,
       ...
       * - '_setCurColor' button
       */
      this._sfG = SmartWidgets.addElement(
        "g",
        {
       ...
       * </g>
       */
      this._btnSelStroke = SmartWidgets.addElement(
        "g",
        {
      ...
      this._actStrokeColor = SmartWidgets.addElement(
        "circle",
        {
      ...
      this._actStrokeNoColor = SmartWidgets.addElement(
        "path",
        {
       ...
       * </g>
       */
      this._btnSelFill = SmartWidgets.addElement(
        "g",
        {
      ...
      this._actFillColor = SmartWidgets.addElement(
        "circle",
        {
      ...
      this._actFillNoColor = SmartWidgets.addElement(
        "path",
        {
          class: "fill-no-color",
          stroke: "#ff0000",
       ...
       */
      this._selNoColorBtn = SmartWidgets.addElement(
        "circle",
        {
      ...
      this._selNoColorLine = SmartWidgets.addElement(
        "line",
        {
       ...
       */
      this._colorSwitch = SmartWidgets.addElement(
        "path",
        {
          class: "color-switch",
       ...
       */
      this._setCurColor = SmartWidgets.addElement(
        "circle",
        {
          class: "set-cur-color",
          cx: 56,
       ...
       */
      this._opacityG = SmartWidgets.addElement(
        "g",
        {
          class: "opacity-group",
      ...
      this._opSlider = SmartWidgets.addElement(
        "rect",
        {
          id: "opacity-slider",
      ...
      this._opInd = SmartWidgets.addElement(
        "circle",
        {
      ...
      if (hbG) {
         ...
         * HUE slider
         */
        ctrls.hueSlider = SmartWidgets.addElement(
          "rect",
          {
            id: "hue-slider",
         ...
         */
        ctrls.satlumColor = SmartWidgets.addElement(
          "rect",
          {
            id: "sat-lum-slider",
         ...
         */
        ctrls.hueCtrl = SmartWidgets.addElement(
          "rect",
          {
            id: "hue-ind",
            class: "hue-ind",
         ...
         */
        ctrls.slCtrl = SmartWidgets.addElement(
          "circle",
          {
            id: "sat-lum-ind",
            class: "sat-lum-ind",
      ...
      if (rgbG) {
        ...
        ctrls.rSliderVal = SmartWidgets.addElement(
          "text",
          {
            id: "rgb-r-val",
            text: "#00",
        ...
        let gr = SmartWidgets.addElement(
          "g",
          {
            id: "r-sliders-g",
            class: "r-sliders-g",
        ...
        ctrls.rSlider = SmartWidgets.addElement(
          "rect",
          {
            id: "r-slider",
        ...
        ctrls.rSliderFrom = SmartWidgets.addElement(
          "rect",
          {
            class: "r-slider-from",
            x: 0,
        ...
        // upper rectangle
        ctrls.rSliderTo = SmartWidgets.addElement(
          "rect",
          {
            class: "r-slider-to",
            x: 0,
        ...
        ctrls.rSliderInd = SmartWidgets.addElement(
          "circle",
          {
            id: "rSliderInd",
            class: "r-slider-ind",
        ...
        ctrls.gSliderVal = SmartWidgets.addElement(
          "text",
          {
            id: "rgb-g-val",
            text: "#00",
        ...
        // draw slider as two rectangles with mask.
        ctrls.gSlider = SmartWidgets.addElement(
          "rect",
          {
            id: "g-slider",
        ...
        // bottom rectangle shows color 'from' and upper one - 'upto' color
        ctrls.gSliderFrom = SmartWidgets.addElement(
          "rect",
          {
            class: "g-slider-from",
            x: 0,
        ...
        // upper rectangle
        ctrls.gSliderTo = SmartWidgets.addElement(
          "rect",
          {
            class: "g-slider-to",
            x: 0,
        ...
        ctrls.gSliderInd = SmartWidgets.addElement(
          "circle",
          {
            id: "g-slider-ind",
            class: "g-slider-ind",
        ...
        ctrls.bSliderVal = SmartWidgets.addElement(
          "text",
          {
            id: "rgb-b-val",
            text: "#00",
        ...
        // draw slider as two rectangles with mask.
        ctrls.bSlider = SmartWidgets.addElement(
          "rect",
          {
            id: "b-slider",
        ...
        // bottom rectangle shows color 'from' and upper one - 'upto' color
        ctrls.bSliderFrom = SmartWidgets.addElement(
          "rect",
          {
            class: "b-slider-from",
            x: 0,
        ...
        // upper rectangle
        ctrls.bSliderTo = SmartWidgets.addElement(
          "rect",
          {
            class: "b-slider-to",
            x: 0,
        ...
        ctrls.bSliderInd = SmartWidgets.addElement(
          "circle",
          {
            id: "b-slider-ind",
            class: "b-slider-ind",
        ...
        ctrls.rgbVal = SmartWidgets.addElement(
          "text",
          {
            text: "#000000",
            x: 153,
        ...
        ctrls.rgbBox = SmartWidgets.addElement(
          "rect",
          {
            id: "rgb-box",
      ...
      ctrls = monoUI.ctrls;
      if (monoG) {
        ctrls.schemeG = SmartWidgets.addElement(
          "g",
          {
            class: "mono-scheme-g",
            style: "cursor:pointer;",
        ...
        const gr = SmartWidgets.addElement(
          "g",
          {
            class: "rgb-box-g",
      ...
      this._ssMenuG = SmartWidgets.addElement(
        "g",
        {
          id: ssmId,
       ...
       */
      this._currentSliderG = SmartWidgets.addElement(
        "g",
        {
      ...
      this._currentSliderTitle = SmartWidgets.addElement(
        "text",
        {
          text: sliderUI.name,
          x: gap,
        ...
        this._currentSliderG,
        this._svgdoc
      );
      this._enterColorBuffer = SmartWidgets.addElement(
        "text",
        {
          text: "",
          x: gap,
       ...
       */
      this._selectSliders = SmartWidgets.addElement(
        "g",
        {
       ...
       */
      this._showHelp = SmartWidgets.addElement(
        "g",
        {
          class: "show-help-btn",
          style: "cursor:pointer;",
      ...
      this._helpLayer = SmartWidgets.addElement(
        "g",
        {
  ...
  _updateTriadicScheme(cr, excludeScheme) {
    if (excludeScheme != "nothing") {
      if (excludeScheme == "exclude-schemes" || (this._currentSliderIndex > 1 && this._currentSliderIndex < 6)) {
        return;
      }
    }
  ...
  _updateRGBSliders(cr) {
    // 'rgb-sliders' - index 1 inside _slidersTypes
  ...
  _updateHueBoxes(cr) {
    // 'hue-boxes' - index 0 inside _slidersTypes
  ...
  init(options = null) {
    ...
    if (triadicUI) {
      ...
      triadicUI.schemeG.addEventListener("click", (evt) => {
        const target = evt.target.nodeName == "text" ? evt.target.previousElementSibling : evt.target.nodeName == "g" ? evt.target.firstElementChild : evt.target;
    ...
    this._currentSliderTitle.addEventListener("keydown", (evt) => {
      switch (evt.keyCode) {
        ...
        case 50: // '2':
        case 51: // '3':
          if (evt.shiftKey && evt.keyCode == 51) {
            // key == '#'
            if (
              (this._enterColorBuffer.textContent.startsWith("r") || this._enterColorBuffer.textContent.startsWith("g") || this._enterColorBuffer.textContent.startsWith("b")) &&
  ...
  setParam(name, value) {
    if (this.dontRespond) {
      // don't respond on changing parameters when updating user panels in UI Builder (for example)
      return;
    }
    const opt = {};
    opt[name] = value;
